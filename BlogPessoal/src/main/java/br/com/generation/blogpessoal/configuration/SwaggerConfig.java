...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Bianca ").description("API Blog Pessoal - Bianca")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Bianca", "https://github.com/byankaa",
				"biancaadecampos123@gmail.com");
	}
